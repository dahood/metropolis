        ...
        private string DisplayTextBasedOnRepositoryType(Instance type)
        {
            if (provider.SourceType == RepositorySourceType.CSharp)
            {
                return string.Format(
                    "CodeBag: {1}{0}Lines Of Code {2}{0}Number Of Methods: {3}{0}Cyclomatic Complexity: {4}{0}Class Coupling: {5}{0}Depth of Inheritance: {6}{0}Toxicity: {7}{0}Namespace: {8}{0}",
            ...
            {
                return string.Format(
                    "CodeBag: {1}{0}Lines Of Code {2}{0}Number Of Methods: {3}{0}Cyclomatic Complexity: {4}{0}ClassFanOut: {5}{0}ClassDataAbstractionCoupling: {6}{0}Anon Inner Classes: {7}{0}Depth of Inheritance: {8}{0}Toxicity: {9}{0}Package: {10}{0}",
            ...
            {
                return string.Format(
                    "File CodeBag: {1}{0}Lines Of Code {2}{0}Number Of Methods: {3}{0}Cyclomatic Complexity: {4}{0}Toxicity: {5}{0}Directory: {6}{0}",
