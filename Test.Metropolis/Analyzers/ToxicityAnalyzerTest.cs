...
namespace Test.Metropolis.Analyzers
{
    ...
    public class ToxicityAnalyzerTest 
    {
        ...
        public void Toxicity_On_ComplexMethod()
        {
            ...
            Assert.AreEqual(0.7, new CsharpToxicityScore(type).Toxicity, Delta);
        }
        ...
        public void Toxicity_On_Deep_Depth_of_Inheritance()
        {
            ...
            Assert.AreEqual(1.6, new CsharpToxicityScore(type).Toxicity, Delta);
        }
        ...
        public void Toxicity_On_Good_Type()
        {
            ...
            Assert.AreEqual(0, new CsharpToxicityScore(type).Toxicity);
        }
        ...
        public void Toxicity_On_VERY_ComplexMethod()
        {
            ...
            Assert.AreEqual(3.55, new CsharpToxicityScore(type).Toxicity, Delta);
        }
        ...
        public void Toxicity_On_VERY_Deep_Depth_of_Inheritance()
        {
            ...
            Assert.AreEqual(4, new CsharpToxicityScore(type).Toxicity, Delta);
        }
        ...
        public void Toxicity_On_VERY_Large_Class_Coupling()
        {
            ...
            Assert.AreEqual(5.4, new CsharpToxicityScore(type).Toxicity, Delta);
        }
        ...
        public void Toxicity_On_VERY_Large_Lines_Of_Code()
        {
            ...
            Assert.AreEqual(6.9, new CsharpToxicityScore(type).Toxicity, Delta);
        }
        ...
        public void Toxicity_On_VERY_LongMethod()
        {
            ...
            Assert.AreEqual(4.2, new CsharpToxicityScore(type).Toxicity, Delta);
        }
    }
}