...
namespace Metropolis.Test.Analyzers
{
    [TestFixture]
    public class ToxicityAnalyzerTest 
    {
        ...
        {
            var type = new Instance("Metropolis", "Canvas", 1, 1, 1, 4, 1);
        ...
        {
            var type = new Instance("Metropolis", "Canvas", 1, 1, 1, 1, 32);
            Assert.AreEqual(0.7, new CSharpToxicityAnalyzer().CalculateToxicity(type).Toxicity, Delta);
        }
        ...
        {
            var type = new Instance("Metropolis", "Canvas", 1, 502, 1, 1, 1);
            Assert.AreEqual(0.7, new CSharpToxicityAnalyzer().CalculateToxicity(type).Toxicity, Delta);
        }
        ...
        {
            var type = new Instance("Metropolis", "Canvas", 1, 1, 1, 14, 1);
        ...
        {
            var type = new Instance("Metropolis", "Canvas", 1, 1, 1, 1, 250);
        ...
        {
            var type = new Instance("Metropolis", "Canvas", 1, 1500, 1, 1, 1);
